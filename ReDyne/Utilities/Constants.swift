...
enum Constants {
    ...
    enum UserDefaultsKeys {
        private static var prefix: String { Constants.App.bundleIdentifier }
        static var recentFiles: String { "\(prefix).recentFiles" }
        static var lastOpenedPath: String { "\(prefix).lastOpenedPath" }
        static var preferredArchitecture: String { "\(prefix).preferredArch" }
        static var disassemblyDetailLevel: String { "\(prefix).detailLevel" }
        static var syntaxHighlightingEnabled: String { "\(prefix).syntaxHighlight" }
        static var useLegacyFilePicker: String { "\(prefix).useLegacyFilePicker" }
    }
    ...
    enum App {
        static var bundleIdentifier: String {
            Bundle.main.bundleIdentifier ?? "com.jian.ReDyne"
        }
        ...
        static var generatorLabel: String {
            "ReDyne \(versionSummary)"
        }
    }
    ...
    enum Processing {
        static let backgroundQueueLabel = "\(Constants.App.bundleIdentifier).backgroundQueue"
...
extension Constants {
    ...
    static func logFilePickerMode() {
        ...
        print("ReDyne \(Constants.App.versionSummary) - File Picker Mode: \(mode), Enhanced Active: \(enhancedActive)")
    }
}
