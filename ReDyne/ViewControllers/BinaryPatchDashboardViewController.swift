...
class BinaryPatchDashboardViewController: UIViewController {
    ...
    @objc private func dismissViewController() {
        // If this controller is embedded in a navigation stack and is not the root,
        // pop it. Otherwise, dismiss the presented navigation controller/modal.
        ...
        // Fallback to dismissing modally
        if presentingViewController != nil {
            dismiss(animated: true, completion: nil)
            return
        }

        // If nothing else, try popping from any parent navigation controller
