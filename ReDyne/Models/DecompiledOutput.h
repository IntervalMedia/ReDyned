...
@property (nonatomic, copy, nullable) NSString *classDumpHeader;
@property (nonatomic, strong, nullable) id typeReconstructionAnalysis;
...
@property (nonatomic, assign) NSUInteger totalReconstructedTypes;
